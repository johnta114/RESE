...
<div class="flex justify-between items-center">
    ...
    <div class="flex justify-between items-center">
        <nav id="nav" class="absolute md:static pt-16 md:pt-0 w-full md:w-auto h-screen md:h-auto top-0 -left-full md:right-0 text-center md:text-left duration-700">
            <ul class="md:flex md:justify-between md:items-center">
                ...
                @guest
                    <li class="nav-item pb-5 md:pb-0 px-0 md:px-4 md:border-l md:border-solid md:border-black">
                        <a class="text-2xl md:text-base text-black font-normal hover:border-b hover:border-solid hover:border-black" href="/register"><i class="fas fa-user-plus pr-2 hidden md:inline-block"></i>会員登録</a>
                    </li>
                    <li class="nav-item pb-5 md:pb-0 px-0 md:px-4 md:border-l md:border-solid md:border-black">
                        <a class="text-2xl md:text-base text-black font-normal hover:border-b hover:border-solid hover:border-black" href="/login"><i class="fas fa-sign-in-alt pr-2 hidden md:inline-block"></i>ログイン</a>
                    </li>
                @endguest
                @auth
                    <form method="POST" action="/mypage">
                        @csrf
                        <li class="nav-item pb-5 md:pb-0 px-0 md:px-4 md:border-l md:border-solid md:border-black">
                            <a class="text-2xl md:text-base text-black font-normal hover:border-b hover:border-solid hover:border-black" href="/mypage"  onclick="event.preventDefault();this.closest('form').submit();"><i class="fas fa-user pr-2 hidden md:inline-block"></i>マイページ</a>
                        </li>
                    </form>
                        @if(Auth::user()->role == 1)
                            <form method="POST" action="/admin">
                                @csrf
                                <li class="nav-item pb-5 md:pb-0 px-0 md:px-4 md:border-l md:border-solid md:border-black">
                                    <a class="text-2xl md:text-base text-black font-normal hover:border-b hover:border-solid hover:border-black" href="/mypage"  onclick="event.preventDefault();this.closest('form').submit();"><i class="fas fa-user-cog pr-2 hidden md:inline-block"></i>システム管理</a>
                                </li>
                            </form>
