        ...
        <div class="w-10/12 mx-auto">
            ...
            <div class="md:flex md:justify-between items-center gap-5">
                <div class="relative z-0 mb-6 w-full group">
                    ...
                    <label for="first_name" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"><i class="fas fa-user pr-2"></i>苗字</label>
                </div>
                <div class="relative z-0 mb-6 w-full group">
                    ...
                    <label for="last_name" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"><i class="fas fa-user pr-2"></i>名前</label>
                </div>
            </div>
            @error('name')
            ...
            <div class="text-right mb-4">
                @csrf
                <button type="submit" class="w-full md:w-auto text-base bg-orange-400 text-white hover:opacity-80 cursor-pointer rounded-md py-2 px-5">登録</button>
            </div>
            <div class="ml-2 mb-5">
