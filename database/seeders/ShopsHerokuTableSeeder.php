...
class ShopsHerokuTableSeeder extends Seeder
{
    private $shops = [
        [
            'shop_name' => '仙人',
        ...
        [
            ...
            'image' => 'storage/temp/yakiniku.jpeg'
        ],
        [
            'shop_name' => '戦慄',
            'user_id' => 4,
            'erea_id' => 394,
            'genre_id' => 24,
            'overview' => '気軽に立ち寄れる昔懐かしの大衆居酒屋です。キンキンに冷えたビールを、なんと199円で。鳥かわ煮込み串は販売総数100,000本突破の名物料理です。仕事帰りに是非御来店ください。',
            'image' => 'storage/temp/izakaya.jpeg'
        ],
        [
            'shop_name' => 'ルーク',
            'user_id' => 4,
            ...
            'image' => 'storage/temp/italian.jpeg'
        ],
        [
            'shop_name' => '志摩屋',
            'user_id' => 4,
